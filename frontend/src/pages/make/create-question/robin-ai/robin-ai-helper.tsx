...
const editGenerateRequest = (currentQuestion: () => QuestionRequest, currentQuestionId?: number) => async (request: RobinAiRequest) => {
    const question = currentQuestion()
    return {
        drafts: [
            await postAiAssistant({
                question: buildEditAiPrompt(request.question, question),
                questionType: question.questionType,
                workspaceGuid: request.workspaceGuid,
...
export const RobinAiHelper = ({ form, currentQuestion, currentQuestionId, workspaceGuid }: RobinAiHelperProps) => {
        ...
        <>
            ...
            {sheetOpen && (
                <RobinSheet
                    ...
                    generateRequest={currentQuestion ? editGenerateRequest(currentQuestion, currentQuestionId) : undefined}
                    undo={undo}
